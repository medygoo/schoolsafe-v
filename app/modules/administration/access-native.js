/* Lectures IAM natives ; le cookie HttpOnly reste la seule session transportée. */
(function (root) {
  "use strict";
  async function read(path) {
    ...
    var response = await fetch(base + "/native/access/" + path, { credentials: "include", cache: "no-store", headers: { Accept: "application/json" } });
    var payload = null;
