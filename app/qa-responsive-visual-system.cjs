...
assert.match(serviceWorker, /CACHE_NAME\s*=\s*CACHE_PREFIX\s*\+\s*["']native-access-assignments-2026-09-16["']/, "La version du cache doit publier les attributions natives");
