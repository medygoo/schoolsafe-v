...
-- Read stored IAM assignments, never impersonate the inspected profile.
-- Mutations and simulations of effective access are separate contracts.
begin;
...
begin
  ...
  with filtered as (
    select r.id, r.code, r.label, r.is_active from iam.roles r
